 ...
 */
@WebServlet(name = "RectangleAreaControllerLab2", urlPatterns = {"/racl2"})
public class RectangleAreaControllerLab2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher view =
            request.getRequestDispatcher("/Lab2.jsp");
